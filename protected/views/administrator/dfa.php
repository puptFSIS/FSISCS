...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Deactivate Faculty Account</h2>
<?php
if (!isset($_GET['msg'])) {
...
<ul class="list-info">
	<li>Are you sure you want to deactivate the account of <?php echo '<strong>'.$FullName.'<strong>';?> </i></li>
</ul><br />
<form id="" action="index.php?r=administrator/processDeactivateFA" method=POST>
