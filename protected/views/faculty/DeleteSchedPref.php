...
<form id="annc" name="annc" action="index.php?r=faculty/processDeleteSchedPref" method="post">
<p style="margin-bottom: 9px;">*Subject to Delete:
...
<center><p style = "margin-left: 70%;"><input type="submit" value="Delete" /> <input type="button" value="Cancel" /></p></center>
</form>
</section>
