...
if($tp2==null || $tp9==null || $tp10==null || $tp11==null || $tp12==null || $tp13==null) {
	...
	header("location: index.php?r=faculty/TrainingProgramNew&msg=Please fill up all the required fields. * Required fields.&msgType=error");

} else if($result == 'ERROR') {

	header("location: index.php?r=faculty/TrainingProgramNew&msg=" . $result_msg . "&msgType=error");
	...
	if($result) {
		...
		header("location: index.php?r=faculty/TrainingPrograms&msg=New training program has been added to your voluntary work.&msgType=succ");
