...
<!-- Page title -->
<title>Scheduling | Set Daily Sched</title>
<!-- Page icon -->
...
<form id="annc" name="annc" action="index.php?r=administrator/ProcessSetDailySched&currID=<?php echo $_GET['currID'];?>&cID=<?php echo $_GET['cID'];?>&yrlvl=<?php echo $_GET['yrlvl'];?>&scode=<?php echo $_GET['scode'];?>&sem=<?php echo $_GET['sem'];?>&sy=<?php echo $_GET['sy'];?>&sec=<?php echo $_GET['sec'];?>&day=<?php echo $_GET['day'];?>" method="post">
<p style="margin-bottom: 9px;">*Prof. Name:
<select name="profName" style="width: 470px; margin-top: -28px; margin-left: 15%;">
	<?php
		$sql="SELECT * FROM tbl_evaluationfaculty where int_courseGroup = 24 and status = 'Active' order by LName";
