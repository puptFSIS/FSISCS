...
<?php
	...
	if($valid)
	{
		...
		if($result)
		{
                    ...
                    {
                        $sql = "UPDATE tbl_requestschedule SET sday = '$day', stimeS = '$timeS', stimeE = '$timeE', sroom = '$roomName', ".
                               "sday2 = '$day2', stimeS2 = '$timeS2', stimeE2 = '$timeE2', sroom2 = '$roomName2' WHERE request_id = '$requestID'";
                    }
                    else
                    {
                        // THIS IS ONLY HAPPENS IF THERE IS A FILE
                        ...
                        $sql = "UPDATE tbl_requestschedule SET sday = '$day', stimeS = '$timeS', stimeE = '$timeE', sroom = '$roomName', ".
                               "sday2 = '$day2', stimeS2 = '$timeS2', stimeE2 = '$timeE2', sroom2 = '$roomName2', uploaded_file = '$uploaded_name' WHERE request_id = '$requestID'";
