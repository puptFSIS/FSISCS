...
<!-- Page title -->
<title>Profile | New Seminar Attended</title>
<!-- Page icon -->
...
<p style="margin-bottom: 9px;">* TITLE:<input name=sa1 type=text style="width: 320px; margin-top: -28px; margin-left: 15%;"  value='<?php ?>'/></p>
<p style="margin-bottom: 9px;">* NATURE:<input name=sa2 type=text style="width: 320px; margin-top: -28px; margin-left: 15%;"  value='<?php ?>'/></p>
...
<p><center><input type=submit value='Save'/></center></p>
</form>
</section>
<!-- End - Video -HTML5 -->
<br/>
