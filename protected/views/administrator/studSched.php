...
<!-- Page title -->
<title>Scheduling | Student Schedule </title>
<!-- Page icon -->
...
<h2 class="underlined-header">Student Daily Schedule</h2>

<br />
	<form name="frmSched" method = "post" action = "index.php?r=administrator/studSched">
		
		<h4>Course, Year & Section</h4>
		...
		<br />
		<h4>Semester</h4>
		<select name = "sem" style="width: 39%;">
			<?php
				$row=1;
				$disp = 0;
				if(isset($_GET['sem']))
...
<section>
    ...
    <h2><a href="index.php?r=administrator/PrintSDS&sem=<?php if(isset($_POST['sem']) and isset($_POST['sy']) and isset($_POST['course'])) { echo $_POST['sem']; }?>&sy=<?php if(isset($_POST['sem']) and isset($_POST['sy']) and isset($_POST['course'])) { echo $_POST['sy']; }?>&course=<?php if(isset($_POST['sem']) and isset($_POST['sy']) and isset($_POST['course'])) { echo $_POST['course']; }?>" class="btn btn-s" target = "blank">Print</a></h2>
<?php } ?>
...
<tbody>
					...
					<?php
						$csem = 0;
						$sy = "";
						if(isset($_POST['sem']) and isset($_POST['sy']) and isset($_POST['course'])) 
						{
							...
							for($ayear=1;$ayear<=$yea;$ayear++) 
							{
								...
								if($csem==1) {
									...
									<h4 class="underlined-header" style = "float:left">'.getCourse($cors).'</h4>
									<h4 class="underlined-header" style = "float:right">'. $ayear.'-1</h4>
									...
									$currID = checkCurrRef($cors,$ayear,$sy);
									...
									*/
									...
									$sql1 = "SELECT * FROM tbl_schedule WHERE sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS < 1030";
									...
									$sql1 = "SELECT * FROM tbl_schedule WHERE sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS2 < 1030";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									';
										...
										{
											echo'
											<td style="text-align: center;" width = "15%">'. $codeM .'<br />'. $roomM .'<br />'. $timeM .'<br />'. $profM . '</td>';
										}elseif($cM > 0)
										{
											if($startM<$startM2)
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeM .'<br />'. $roomM .'<br />'. $timeM .'<br />'. $profM . '<br />'.' / '. $codeM2 .'<br />'. $roomM2 .'<br />'. $timeM2 .'<br />'. $profM2 .'</td>';
											}else
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeM2 .'<br />'. $roomM2 .'<br />'. $timeM2 .'<br />'. $profM2 . '<br />'.' / '. $codeM .'<br />'. $roomM .'<br />'. $timeM .'<br />'. $profM .'</td>';
											}
										}
										if($cT == 0 or ($cT > 0 and $codeT2 == ""))
										{
											echo'
											<td style="text-align: center;" width = "15%">'. $codeT .'<br />'. $roomT .'<br />'. $timeT .'<br />'. $profT . '</td>';
										}
										elseif($cT > 0)
										{
											if($startT<$startT2)
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeT .'<br />'. $roomT .'<br />'. $timeT .'<br />'. $profT . '<br />'.' / '. $codeT2 .'<br />'. $roomT2 .'<br />'. $timeT2 .'<br />'. $profT2 .'</td>';
											}
											else
											{
												echo'
											<td style="text-align: center;" width = "15%">'. $codeT2 .'<br />'. $roomT2 .'<br />'. $timeT2 .'<br />'. $profT2 . '<br />'.' / '. $codeT .'<br />'. $roomT .'<br />'. $timeT .'<br />'. $profT .'</td>';
											}
										}
										if($cW == 0 or ($cW > 0 and $codeW2 == ""))
										{
											echo'
											<td style="text-align: center;" width = "15%">'. $codeW .'<br />'. $roomW .'<br />'. $timeW .'<br />'. $profW . '</td>';
										}
										elseif($cW > 0)
										{
											if($startW<$startW2)
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeW .'<br />'. $roomW .'<br />'. $timeW .'<br />'. $profW . '<br />'.' / '. $codeW2 .'<br />'. $roomW2 .'<br />'. $timeW2 .'<br />'. $profW2 .'</td>';
											}
											else
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeW2 .'<br />'. $roomW2 .'<br />'. $timeW2 .'<br />'. $profW2 . '<br />'.' / '. $codeW .'<br />'. $roomW .'<br />'. $timeW .'<br />'. $profW .'</td>';
											}
										}
										if($cTH == 0 or ($cTH > 0 and $codeTH2 == ""))
										{
											echo'
											<td style="text-align: center;" width = "15%">'. $codeTH .'<br />'. $roomTH .'<br />'. $timeTH .'<br />'. $profTH . '</td>';
										}
										elseif($cTH > 0)
										{	
											if($startTH<$startTH2)
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeTH .'<br />'. $roomTH .'<br />'. $timeTH .'<br />'. $profTH . '<br />'.' / '. $codeTH2 .'<br />'. $roomTH2 .'<br />'. $timeTH2 .'<br />'. $profTH2 .'</td>';
											}
											else
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeTH2 .'<br />'. $roomTH2 .'<br />'. $timeTH2 .'<br />'. $profTH2 . '<br />'.' / '. $codeTH .'<br />'. $roomTH .'<br />'. $timeTH .'<br />'. $profTH .'</td>';
											}
										}
										if($cF == 0 or ($cF > 0 and $codeF2 == ""))
										{
											echo'
											<td style="text-align: center;" width = "15%">'. $codeF .'<br />'. $roomF .'<br />'. $timeF .'<br />'. $profF . '</td>';
										}
										elseif($cF > 0)
										{
											if($startF<$startF2)
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeF .'<br />'. $roomF .'<br />'. $timeF .'<br />'. $profF . '<br />'.' / '. $codeF2 .'<br />'. $roomF2 .'<br />'. $timeF2 .'<br />'. $profF2 .'</td>';
											}
											else
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeF2 .'<br />'. $roomF2 .'<br />'. $timeF2 .'<br />'. $profF2 . '<br />'.' / '. $codeF .'<br />'. $roomF .'<br />'. $timeF .'<br />'. $profF .'</td>';
											}
										}
										if($cS == 0 or ($cS > 0 and $codeS2 == ""))
										{
											echo'
											<td style="text-align: center;" width = "15%">'. $codeS .'<br />'. $roomS .'<br />'. $timeS .'<br />'. $profS . '</td>';
										}
										elseif($cS > 0)
										{
											if($startS<$startS2)
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeS .'<br />'. $roomS .'<br />'. $timeS .'<br />'. $profS . '<br />'.' / '. $codeS2 .'<br />'. $roomS2 .'<br />'. $timeS2 .'<br />'. $profS2 .'</td>';
											}
											else
											{
												echo'
												<td style="text-align: center;" width = "15%">'. $codeS2 .'<br />'. $roomS2 .'<br />'. $timeS2 .'<br />'. $profS2 . '<br />'.' / '. $codeS .'<br />'. $roomS .'<br />'. $timeS .'<br />'. $profS .'</td>';
											}
										}
									echo'
									</tr>';
									...
									*/
									...
									$sql1 = "SELECT * FROM tbl_schedule WHERE (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS >= 1030 and stimeS < 1330) or (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS < 1030 and stimeE > 1030)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									$sql1 = "SELECT * FROM tbl_schedule WHERE (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS2 >= 1030 and stimeS2 < 1330) or (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS2 < 1030 and stimeE2 > 1030)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									*/
									...
									$sql1 = "SELECT * FROM tbl_schedule WHERE (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS >=1330 and stimeS <1630) or (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS < 1330 and stimeE > 1330)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									$sql1 = "SELECT * FROM tbl_schedule WHERE (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS2 >=1330 and stimeS2 <1630) or (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS2 < 1330 and stimeE2 > 1330)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									*/
									...
									$sql1 = "SELECT * FROM tbl_schedule WHERE (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS >= 1630) or (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS < 1630 and stimeE > 1630)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									$sql1 = "SELECT * FROM tbl_schedule WHERE (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS2 >= 1630) or (sem = '$csem' and schoolYear = '$sy' and courseID = '$cors' and currID = '$currID' and cyear = '$ayear' and stimeS2 < 1630 and stimeE2 > 1630)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
						...
						function getCourse($ccode) 
						{
							...
							$result = mysqli_query($conn,$sql);
							$row = mysqli_fetch_array($result);
							$code = $row['course_code'].' ('.$row['course_desc'].')';
							return $code;
						}
