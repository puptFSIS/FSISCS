...
<li>
<a href="index.php?r=administrator/crcse&type=<?php echo $_GET['type'];?>&rating=<?php echo $_GET['rating'];?>&fm=<?php echo $_GET['fm'];?>&fd=<?php echo $_GET['fd'];?>&fy=<?php echo $_GET['fy'];?>&tm=<?php echo $_GET['tm'];?>&td=<?php echo $_GET['td'];?>&ty=<?php echo $_GET['ty'];?>" style="margin-top:-50px; margin-left:530px;">Remove</a>
</li>
</ul>
<?php
	if(isset($_GET['msg'])) {
...
?>
<form id=ncse action="index.php?r=administrator/processUpdateCSE" method=POST>
...
<p><center><input type=submit value='Save Changes'/><a href="index.php?r=administrator/communitySE"> <input type=button value='Cancel'/></a></center></p>
