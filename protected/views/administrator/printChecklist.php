...
class PDF extends FPDF
{
	...
	{	include("config.php");			
		...
		$this->Cell(0,3,'as of ' . $fromMonth .' '.$yfrom,0,0,'C');
		$this->Ln(15);
		...
		$query = "SELECT * FROM tbl_masterlist WHERE Status = 'BO' AND schoolYear = '$schoolYear' ORDER BY FName ASC";
		...
		$query = "SELECT * FROM tbl_masterlist WHERE Status = 'FT' AND schoolYear = '$schoolYear' ORDER BY FName ASC";
		$result = mysqli_query($conn,$query);
		$this->SetFont('segoeui','',10);
		$this->SetFillColor(245,245,245);
		$this->SetTextColor(0);
		...
		$query = "SELECT * FROM tbl_masterlist WHERE Status = 'PT' AND schoolYear = '$schoolYear' ORDER BY FName ASC";
		$result = mysqli_query($conn,$query);
		$this->SetFont('segoeui','',10);
		$this->SetFillColor(245,245,245);
		$this->SetTextColor(0);
		...
		$query = "SELECT * FROM tbl_masterlist WHERE Status = 'NF' AND schoolYear = '$schoolYear' ORDER BY FName ASC";
		$result = mysqli_query($conn,$query);
		$this->SetFont('segoeui','',10);
		$this->SetFillColor(245,245,245);
		$this->SetTextColor(0);
		...
		$this->Ln(10);
		$this->SetFont('segoeuib','',16);
		$this->Cell(0,3,'ADMINISTRATIVE STAFF CHECKLIST',0,0,'C');
		$this->Ln(5);
		$this->SetFont('segoeuii','',10);
		$this->Cell(0,3,'as of ' . date ('F') .' '.date('Y'),0,0,'C');
		$this->Ln(10);
		...
		$query = "SELECT * FROM tbl_masterlist WHERE Status = 'AS' AND schoolYear = '$schoolYear' ORDER BY FName ASC";
		$result = mysqli_query($conn,$query);
		$this->SetFont('segoeui','',10);
		$this->SetFillColor(245,245,245);
		$this->SetTextColor(0);
		...
		$query = "SELECT * FROM tbl_masterlist WHERE Status = 'SG' AND schoolYear = '$schoolYear' ORDER BY FName ASC";
		$result = mysqli_query($conn,$query);
		$this->SetFont('segoeui','',10);
		$this->SetFillColor(245,245,245);
		$this->SetTextColor(0);
