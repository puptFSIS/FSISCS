...
<form id="annc" name="annc" action="index.php?r=administrator/TimePreferProcessUPDATE&sem=<?php echo $_GET['sem']?>&sy=<?php echo $_GET['sy']?>&timeID=<?php echo $timeID;?>" method="post">
