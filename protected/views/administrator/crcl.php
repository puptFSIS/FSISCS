...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Remove Faculty from Checklist</h2>
	<?php  
	...
	<div class="box-success">
	  <div class="box-content">
		<p>Do you really want to remove <strong><?php echo $roomName; ?> </strong>from the list of <?php echo $status; ?>?</p>
	  </div>
	</div>
	<br />
	<center>
		<a href="index.php?r=administrator/processDeleteInfoReport&ID=<?php echo $ID; ?>"><input type="button" value="Yes"></a>
