...
<h2 class=underlined-header><strong>INDIVIDUAL PERFORMANCE, COMMITMENT AND REVIEW</strong></h2>
...
<?php
 ...
 ?>
<p style="font-size: 17px;">View Proof for Accomplishment</p>
...
<p style="margin-bottom: 9px; font-size: 15px;"><strong>Actual Accomplishments:</strong><textarea readonly name="accomplishment" type=text style="width: 400px; height: 150px; margin-top: -28px; margin-left: 33%;"><?php echo $accomp; ?></textarea></p>
