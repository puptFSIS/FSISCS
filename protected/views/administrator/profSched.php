...
<h2 class="underlined-header">Faculty Daily Schedule</h2>
<a href="index.php?r=administrator/internalprofSched" id="internal_fac">Go to Internal Faculty Schedules</a>
<br />
	<form name="frmSched" method = "post" action = "index.php?r=administrator/profSched">
		<h4>Semester</h4>
