...
<br /><center><a href="index.php?r=faculty/rscho&name=<?php echo $n;?>&school=<?php echo $s;?>"><input type=button value=Yes></a>
<a href="index.php?r=faculty/scholarships"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
