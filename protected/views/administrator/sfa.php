...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Search Faculty Account</h2>
<?php 
if (!isset($_GET['msg'])) {
...
<ul class="list-info">
	<li><i>Search for faculty account.</i></li>
</ul><br />
<form id="" action="index.php?r=administrator/processSFA" method=POST>
...
if ($res==1) {
		...
		<a href=\'index.php?r=administrator/vfa&empID=' . $EmpID . '\'>View Profile</a>
		</span>
		</li>
		<!-- End - Post item -->
		</ul>
