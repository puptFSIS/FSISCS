...
<?php endif;?>
    ...
    <a class="btn btn-primary" href="index.php?r=faculty/AddMakeupClass">Request Make Up Class</a>
...
<tbody>
    ...
    <table class="table table-bordered table-hover responsive-utilities">
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM tbl_makeup_class WHERE FCode='$requestedBy'";
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary"
                               href="<?php echo "index.php?r=faculty/UpdateMakeupClass&makeupClassID=".$row['MakeupClassID']; ?>">Update</a>
                            <a class="btn btn-primarydel"
                               href="<?php echo "index.php?r=faculty/ProcessDeleteMakeupClass&makeupClassID=".$row['MakeupClassID']; ?>">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php endif; ?>
    ...
    <table class="table table-bordered table-hover responsive-utilities">
        <h2>Approved Make Up Classes</h2>
        <thead>
            <tr>
                <th>Requested By</th>
                <th>Course</th>
        ...
        <tbody>
            ...
            // Get your requests
            $requestedBy = $_SESSION['FCode'];
            $sql = "SELECT * FROM tbl_makeup_class WHERE FCode='$requestedBy' AND isApproved IS NOT NULL";
            $result = mysqli_query($conn, $sql);
            ?>
...
<script>
    $('.btn-primarydel').on('click', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'Deleting this Requested Schedule?',
            icon: 'warning',
    ...
    if(flashdata==1){
        Swal.fire({
            icon:'success',
            title:'Success!',
            text:'Makeup Class Request is now Pending!',
            timer: '2000'
        })
    }
    ...
    if(flashdata==2){
        Swal.fire({
            icon:'success',
            title:'Success!',
            text:'Requested Schedule Updated',
            timer: '2000'
        })
    }
    ...
    if(flashdata==3){
        Swal.fire({
            icon:'success',
            title:'Success!',
            text:'Requested Schedule Deleted',
            timer: '2000'
        })
    }
</script>
