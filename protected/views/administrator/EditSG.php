...
<!-- Page title -->
<title>Faculty | Edit Security Guard Status</title>
<!-- Page icon -->
...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Edit Security Guard Status</h2>
<br>
<?php
if (!isset($_GET['msg'])) {
...
<p style="margin-bottom: 9px; font-size:1.15em; display:inline;">Faculty Code: <strong style="margin-left: 18%; "><?php echo $SGCode ; ?></strong>	</p>
<input id=EmpID name="FCode" type="hidden" value="<?php echo $SGCode; ?>" required/>
<br>
<br>
<p style="font-size:1.15em;">Administrative Staff Name: <b style=" margin-left: 5%;"><?php echo $SGName; ?></b></p>
<p style="margin-bottom: 9px; font-size:1.15em;">Security Guard Status:
	<select name = "Fstatus" style="width: 30%; display:inline; margin-left: 9%;" required>				
