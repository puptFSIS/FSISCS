...
include("taxinfo.php");
	echo '	
	<form name="tcert" action="index.php?r=faculty/ProcessUpdateTC" method="post">
...
<?php
	echo'
	<p><center><input type="submit" value="Save Changes" /> <a href="index.php?r=faculty/TaxCertificate"><input type="button" value="Cancel" /></a></center></p>
	</form>';
?>
