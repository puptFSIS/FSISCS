...
<!-- Page title -->
<title>Faculty | Edit Faculty Status</title>
<!-- Page icon -->
...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Edit New Faculty Status</h2>
<br>
<?php
if (!isset($_GET['msg'])) {
...
<?php
	...
	$PFCode = $_GET['NFCode'];
	$FFCode = $_GET['NFCode'];
	echo "<p style='font-size:1.15em;'>Faculty Name: <b style=' margin-left: 5%;'>". $NFName ."</b>";
?>
<form id="" action="index.php?r=administrator/processENFS" method=POST>
<p style="margin-bottom: 9px; font-size:1.15em;">Final FCode: <input id=EmpID name="FFCode" type=text style="width: 30%; margin-top: -28px; margin-left: 20%;" value="<?php echo $FFCode; ?>" /></p>
<input id=EmpID name="PFCode" type="hidden" value="<?php echo $FFCode; ?>" required/>
<p style="margin-bottom: 9px; font-size:1.15em;">Faculty Status:
	<select name = "nfstatus" style="width: 30%; display:inline; margin-left: 4%;" required>				
