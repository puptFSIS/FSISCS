...
?>
<form id=ncse action="index.php?r=administrator/processInsertCSE" method=POST>
<p style="margin-bottom: 9px;">* TYPE:
<input name=tb1 type=text style="width: 44%; margin-top: -28px; margin-left: 25%;" />
</p>
...
<p><center><input type=submit value='Save'/><a href="index.php?r=administrator/communitySE"><input type=button value='Cancel'/></a></center></p>
