...
if($emptyfield==1) {
	header("location:index.php?r=faculty/ci&msg=There is $emptyfield unnamed child&no=$noOfChild");
} else if($emptyfield>1)
	header("location:index.php?r=faculty/ci&msg=There is $emptyfield unnamed children&no=$noOfChild");
else {
		...
		header("location:index.php?r=faculty/fb");
}
mysqli_close($conn);
?>