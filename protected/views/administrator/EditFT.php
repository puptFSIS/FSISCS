...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Edit Full Time Faculty Status</h2>
<br>
<?php
if (!isset($_GET['msg'])) {
...
<p style="margin-bottom: 9px; font-size:1.15em; display:inline;">Faculty Code: <strong style="margin-left: 18%; "><?php echo $FTCode ; ?></strong>	</p>
<input id=EmpID name="FCode" type="hidden" value="<?php echo $FTCode; ?>" required/>
<br>
<br>
<p style="font-size:1.15em;">Administrative Staff Name: <b style=" margin-left: 5%;"><?php echo $FTName; ?></b></p>
