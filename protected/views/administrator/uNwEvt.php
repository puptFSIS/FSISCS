...
<!-- Video - HTML5 -->
<section>
<?php include("getNwEvtDetails.php");?>
<h2 class=underlined-header>Update News &amp; Events</h2>
<p>* Required fields.</p>
<hr style="margin-top: -10px;" />
<form id="annc" name="annc" action="index.php?r=administrator/processUpdateNwEvt&id=<?php echo $_GET['id'];?>" method="post">
...
<center><p><input type="submit" value="Save Changes" /> <a href="index.php?r=administrator/newsandevents"><input type="button" value="Cancel" /></a></p></center>
</form>
</section>
<!-- End - Video -HTML5 -->
<br/>
