...
?>
<form id=we action="index.php?r=faculty/processInsertSA" method=POST>
...
<p><center><input type=submit value='Save'/><a href="index.php?r=faculty/sa"><input type=button value='Cancel'/></a></center></p>
</form>
</section>
<!-- End - Video -HTML5 -->
<br/>
