...
<!-- Page title -->
<title>Scheduling | Subject Daily Sched </title>
<!-- Page icon -->
...
<h2 class="underlined-header">Daily Subject Schedule</h2>
<a href="index.php?r=administrator/InternalDailySched" id="internal_dly">Go to Internal Daily Schedules</a>
<br />
<br />
	<form name="frmSched" method = "post" action = "index.php?r=administrator/DailySched">
		<h4>Semester</h4>
...
<tbody>
					...
					<?php
						...
						if(isset($_POST['sem']) and isset($_POST['sy']) and isset ($_POST['day']))
						{
							...
							$sql = "SELECT * FROM tbl_schedule WHERE (sem='$csem' AND schoolYear = '$sy' and sday = '$day') or (sem='$csem' AND schoolYear = '$sy' and sday2 = '$day')";
						...
						{
							include("config.php");
							$sql ="SELECT * FROM tbl_schedule where (scode ='$scode' and sem = '$sem' and schoolYear = '$sy' and courseID = '$cID' and sday = '$day') or (scode ='$scode' and sem = '$sem' and schoolYear = '$sy' and courseID = '$cID' and sday2 = '$day')";
							$result = mysqli_query($conn,$sql);
