...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Confirmation</h2>
<?php
$title = $_GET['Title'];
...
<div class="box-success">
  <div class="box-content">
	<p>Do you really want to remove <?php echo $title;?> by <?php echo $authors;?> from your refereed publications?</p>
  </div>
</div>
<br /><center><a href="index.php?r=administrator/rrp&Title=<?php echo $title;?>&Journal=<?php echo $journal;?>&Editors=<?php echo $editors;?>&Volume=<?php echo $volume;?>&Level=<?php echo $level;?>&Authors=<?php echo $authors;?>"><input type=button value=Yes></a>
<a href="index.php?r=administrator/refereedPublications"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
