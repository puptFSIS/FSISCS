...
<h2 class="underlined-header">Tag Subjects</h2>
<br />
<br />
<?php
		$currYear=date("Y")+1;
	...
	?>
	<form name="frmSched" method = "post" action = "index.php?r=administrator/tagSubjectspage">
		<h4 class="underlined-header">Semester</h4>
		<select name = "sem" style="width: 50%;">
			<?php
				$row=1;
				$disp = 0;
				if(isset($_GET['sem']))
		...
		<input type="submit" name="btnSubmit" value="View Subjects" />
		</form>
