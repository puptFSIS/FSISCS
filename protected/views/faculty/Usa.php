...
<li>
<a href="index.php?r=faculty/crsa&t=<?php echo $t;?>&n=<?php echo $n;?>&s=<?php echo $s;?>" style="margin-top:-50px; margin-left:530px;">Remove</a>
</li>
</ul>
<ul class=list-info>
...
<form id=we action="index.php?r=faculty/processUpdateSA&t=<?php echo $t;?>&n=<?php echo $n;?>&s=<?php echo $s;?>" method=POST>
...
<p><center><input type=submit value='Save Changes'/><a href="index.php?r=faculty/sa"><input type=button value='Cancel'/></a></center></p>
</form>
</section>
<!-- End - Video -HTML5 -->
<br/>
