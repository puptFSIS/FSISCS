...
<!-- Page title -->
<title>Reports | Faculty Quarterly Attendance in Seminar</title>
<!-- Page icon -->
...
<!-- Video - HTML5 -->
<section>
	<h2 class="underlined-header">Faculty Quarterly Attendance in Seminar Report</h2>
	<form name="FASQcov" action="index.php?r=administrator/report&content=FASQ" method="POST" target="_blank">
		Quarter: 
		<p>
			<select name="quarter" style="width: 25%">
			...
			<select name="yearCov" style="width: 25%">
				<?php
					$currYear=date("Y");
