...
<!-- Page title -->
<title>Faculty | Deactivate</title>
<!-- Page icon -->
...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Getting Started with FSIS</h2>

<!-- End - Item description -->
<ul class="list-info">
	<li><i>Search for faculty account to update.</i></li>
</ul><br />
<form id="" action="index.php?r=administrator/sdfa" method=POST>
...
$msg = $_GET['msg'];
	if($_GET['msgType']=="suc") {
		...
		$EmpID=$_GET['EmpID'];
		echo '<br /><center><p>
		<a href="index.php?r=administrator/processDeactivateFA&EmpID=' . $EmpID .' "><input type=submit value=Deactivate /></a>
...
<li>
<a href='index.php?r=administrator/nfa' >New Faculty Account</a>
</li>
<li>
<a href='index.php?r=administrator/mfa' >Modify Faculty Account</a>
</li>
<li>
<a href='index.php?r=administrator/dfa' >Deactivate Faculty Account</a>
</li>
<li>
<a href='index.php?r=administrator/sfa' >Search Faculty Account</a>
</li>
<li>
