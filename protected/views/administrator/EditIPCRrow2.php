...
if(isset($_GET['m'],$_GET['y']))
    {
        $m = $_GET['m'];
        $y = $_GET['y'];
    echo '<form action="index.php?r=administrator/processEditIPCR2&m='.$m.'&y='.$y.'" method="post">';
    }
?>
...
<center><button type="submit" name="submit">Save</button><a href="index.php?r=administrator/IPCRcreatejultodec">
<button type="button" name="cancel">Cancel</button></a></center>
</form>
