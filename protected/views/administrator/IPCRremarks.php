...
<?php
if(isset($_GET['m'],$_GET['y'],$_GET['id']))
    {
        $m = $_GET['m'];
        $y = $_GET['y'];
        $id = $_GET['id'];
...
<?php  
    ...
    $sql = "SELECT * FROM tbl_ipcraccomp WHERE id = $id ";
...
<textarea id="hdn-txtarea" type="hidden" name="id" ><?php echo $id;?></textarea>
<input type="hidden" name="m" value="<?php echo $m; ?>">
<input type="hidden" name="y" value="<?php echo $y; ?>">
<p style="margin-bottom: 9px; font-size: 20px;"><strong>REMARKS:</strong><textarea name="remarks" type=text><?php echo $remarks; ?></textarea></p>
<br>
...
<center>
    ...
    if ($remarks != NULL)
    {
        echo '<button onclick="history.back()" type="button" name="cancel">Cancel</button></a>';
    } else {
        echo '<button onclick="history.go(-2)" type="button" name="cancel">Cancel</button></a>';
    }
    ?>
</center>
</form>
