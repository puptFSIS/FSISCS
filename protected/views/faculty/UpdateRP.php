...
<li>
<a href="index.php?r=faculty/crrp&Title=<?php echo $title;?>&Journal=<?php echo $journal;?>&Editors=<?php echo $editors;?>&Volume=<?php echo $volume;?>&Level=<?php echo $level;?>&Authors=<?php echo $authors;?>" style="margin-top:-50px; margin-left:530px;">Remove</a>
</li>
</ul>
<?php
	if(isset($_GET['msg'])) {
...
<form id=newproorg action="index.php?r=faculty/processUpdateRP&Title=<?php echo $title;?>&Journal=<?php echo $journal;?>&Editors=<?php echo $editors;?>&Volume=<?php echo $volume;?>&Level=<?php echo $level;?>&Authors=<?php echo $authors;?>" method=POST>
