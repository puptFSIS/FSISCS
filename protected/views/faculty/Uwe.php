...
<li>
<a href="index.php?r=faculty/crwe&com=<?php echo $d8;?>&pos=<?php echo $d7;?>&fromm=<?php echo $fm;?>&fromd=<?php echo $fd;?>&fromy=<?php echo $fy;?>&tom=<?php echo $tm;?>&td=<?php echo $td;?>&toy=<?php echo $ty;?>" style="margin-top:-50px; margin-left:537px;">Remove</a>
</li>
</ul>
<?php
...
<form id=we action=<?php
	if(isset($_GET['mode'])) {
		...
		echo 'index.php?r=faculty/processUpdateWE&mode=0&oldpos=' . $pos . '&oldcom=' . $d4;
	}
?> method=POST>
...
?>
<p><center><input type=submit value='Save Changes'/> <a href="index.php?r=faculty/we"><input type="button" value='Cancel'/></a></center></p>
</form>
</section>
<!-- End - Video -HTML5 -->
<br/>
