...
<h2 class=underlined-header>Announcements</h2>
<ul class=tags-floated-list>
<li>
<a href="index.php?r=administrator/AnncNew" style="margin-top:-50px; margin-left:545px;">Create</a>
</li>
</ul>
<?php
	if(isset($_GET['msg'])) {
...
?>
<?php include("getAnnouncements.php");?>
