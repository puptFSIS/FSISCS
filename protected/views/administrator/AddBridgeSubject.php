...
<form id="annc" name="annc" action="index.php?r=administrator/ProcessAddBridgeSubject" method="post">


    <p style="margin-bottom: 9px;">*Subject Code:
        <input name="scode" type=text style="width: 470px; margin-top: -28px; margin-left: 15%;"  placeholder='Subject Code'/>
    </p>
    <p style="margin-bottom: 9px;">*Subject Title:
        <input name="stitle" type=text style="width: 470px; margin-top: -28px; margin-left: 15%;"  placeholder='Subject Title'/>
    </p>
