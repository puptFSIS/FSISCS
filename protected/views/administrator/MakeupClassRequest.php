...
<tbody>
    ...
    <table class="table table-bordered table-hover responsive-utilities">
        ...
        <tbody>
            ...
            <?php
            // only get the records that have isApproved as null
            $sql = "SELECT * FROM tbl_makeup_class WHERE isApproved IS NULL ORDER BY isApproved ASC";
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary"
                               href="<?php echo "index.php?r=administrator/ApproveMakeupClass&makeupClassID=".$row['MakeupClassID']; ?>">Approve</a>
                            <a class="btn btn-primary"
                               href="<?php echo "index.php?r=administrator/DeclineMakeupClass&makeupClassID=".$row['MakeupClassID']; ?>">Decline</a>
                        </td>
    ...
    <table class="table table-bordered table-hover responsive-utilities">
        ...
        <tbody>
            ...
            <?php
            // only get the records that have isApproved as is not null 
            $sql = "SELECT * FROM tbl_makeup_class WHERE isApproved IS NOT NULL";
            $result = mysqli_query($conn,$sql);
            ?>
