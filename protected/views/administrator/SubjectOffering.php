...
<!-- Page title -->
<title>Administrator | Subject Offerings</title>
<!-- Page icon -->
...
<h2 class="underlined-header">Subject Offerings</h2>
<br />
	<form name="frmSched" method = "post" target = "blank" action = "index.php?r=administrator/PrintSubjectOfferings">
