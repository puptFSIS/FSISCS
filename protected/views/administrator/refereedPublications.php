...
<h2 class=underlined-header>Refereed Publications</h2>

<ul class=tags-floated-list>
<li>
<a href="index.php?r=administrator/NewRefereedPublication" style="margin-top:-50px; margin-left:530px;">Add New</a>
</li>
</ul>
<?php
	if(isset($_GET['msg'])) {
