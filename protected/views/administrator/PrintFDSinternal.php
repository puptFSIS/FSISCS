...
class PDF extends FPDF
{
	...
	function table($cYear)
	{
		...
		*/
		...
		$sql1 = "SELECT * FROM tbl_internaschedule WHERE sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS < 1030";
		...
		$sql1 = "SELECT * FROM tbl_internaschedule WHERE sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS2 < 1030";
		$query1 = mysqli_query($conn,$sql1);
		while($row1 = mysqli_fetch_array($query1))
		{
			$currID = $row1['currID'];
		...
		*/
		...
		$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS >= 1030 and stimeS <1330) or (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS < 1030 and stimeE > 1030)";
		$query1 = mysqli_query($conn,$sql1);
		while($row1 = mysqli_fetch_array($query1))
		{
			$currID = $row1['currID'];
		...
		$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS2 >= 1030 and stimeS2 <1330) or (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS2 < 1030 and stimeE2 > 1030)";
		$query1 = mysqli_query($conn,$sql1);
		while($row1 = mysqli_fetch_array($query1))
		{
			$currID = $row1['currID'];
		...
		*/
		...
		$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS >=1330 and stimeS <1630) or (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS < 1330 and stimeE > 1330)";
		$query1 = mysqli_query($conn,$sql1);
		while($row1 = mysqli_fetch_array($query1))
		{
			$currID = $row1['currID'];
		...
		$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS2 >=1330 and stimeS2 <1630) or (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS2 < 1330 and stimeE2 > 1330)";
		$query1 = mysqli_query($conn,$sql1);
		while($row1 = mysqli_fetch_array($query1))
		{
			$currID = $row1['currID'];
		...
		*/
		...
		$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS >= 1630) or (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS < 1630 and stimeE > 1630)";
		$query1 = mysqli_query($conn,$sql1);
		while($row1 = mysqli_fetch_array($query1))
		{
			$currID = $row1['currID'];
		...
		$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS2 >= 1630) or (sem = '$csem' and schoolYear = '$sy' and sprof = '$prof' and stimeS2 < 1630 and stimeE2 > 1630)";
		$query1 = mysqli_query($conn,$sql1);
		while($row1 = mysqli_fetch_array($query1))
		{
			$currID = $row1['currID'];
