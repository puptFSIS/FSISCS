...
<h2 class=underlined-header>Add Part Time Faculty</h2>
...
<form id="annc" name="annc" action="index.php?r=administrator/processAddPartTime" method="post">
<p style="margin-bottom: 9px;">*Name:
<select name="PTFCode" id = "sy" style="width: 50%;">
