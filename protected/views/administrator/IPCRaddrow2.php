...
if(isset($_GET['m'],$_GET['y']))
    {
        ...
        $y = $_GET['y'];
    echo'<br>
    <form action="index.php?r=administrator/ProcessIPCRinfo2&m='.$m.'&y='.$y.'" method="post">
    ...
    echo '<textarea style="display: none; border: none; background-color: transparent; resize: none; outline: none;" type="hidden" name="month">' .$m. '</textarea>';
    echo '<textarea style="display: none; border: none; background-color: transparent; resize: none; outline: none;" type="hidden" name="year">' .$y. '</textarea>';
    }
?>
