...
<!-- Page title -->
<title>Faculty | Edit Administrative Staff Status</title>
<!-- Page icon -->
...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Edit Administrative Staff Status</h2>
<br>
<?php
if (!isset($_GET['msg'])) {
...
<p style="margin-bottom: 9px; font-size:1.15em; display:inline;">Faculty Code: <strong style="margin-left: 18%; "><?php echo $ASCode ; ?></strong>	</p>
<input id=EmpID name="FCode" type="hidden" value="<?php echo $ASCode; ?>" required/>
<br>
<br>
<p style="font-size:1.15em;">Administrative Staff Name: <b style=" margin-left: 5%;"><?php echo $ASName; ?></b></p>
<p style="margin-bottom: 9px; font-size:1.15em;">Administrative Staff Status:
	<select name = "Fstatus" style="width: 30%; display:inline; margin-left: 4%;" required>				
