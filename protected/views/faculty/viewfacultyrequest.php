...
<form
    action="index.php?r=faculty/processrequestsched&sprof=<?php echo $_GET['sprof']?>&currID=<?php echo $_GET['CurrID'];?>&schedID=<?php echo $_GET['schedID']; ?>&courseID=<?php echo $_GET['courseID'];?>&cyear=<?php echo $_GET['cyear'];?>&scode=<?php echo $_GET['scode'];?>&sem=<?php echo $_GET['sem'];?>&sy=<?php echo $_GET['sy'];?>&sec=<?php echo $_GET['sec'];?>&title=<?php echo $_GET['title'];?>&units=<?php echo $_GET['units'];?>&lec=<?php echo $_GET['lec'];?>&lab=<?php echo $_GET['lab'];?>"
    method="POST"
...
<center><input type="submit" class="btn btn-primary" value="Request"></input></center>
