...
?>
<h2 class=underlined-header>Add Voluntary Work</h2>
<?php
	if(isset($_GET['msg'])) {
	$msg = $_GET['msg'];
		echo '
...
?>
<form id=we action="index.php?r=administrator/ProcessInsertVWork" method="post">
<p style="margin-bottom: 9px;">* NAME OF ORGANIZATION:<input name=v1 type=text style="width: 320px; margin-top: -28px; margin-left: 35%;"  value='<?php ?>'/></p>
<p style="margin-bottom: 9px;"> ADDRESS OF ORGANIZATION:<input name=v2 type=text style="width: 320px; margin-top: -28px; margin-left: 35%;"  value='<?php ?>'/></p>
...
</p><p style="margin-bottom: 9px; margin-top: 0px;"> NO. OF HOURS:<input name=v9 type=text style="width: 50px; margin-top: -28px; margin-left: 35%;"  value='<?php ?>'/></p>
<p style="margin-bottom: 9px;">* POSITION/NATURE OF WORK:<input name=v10 type=text style="width: 150px; margin-top: -28px; margin-left: 35%;"  value='<?php ?>'/></p>
