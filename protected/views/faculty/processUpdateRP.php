...
if($rp1==null || $rp2==null || $rp3==null || $rp4==null || $rp5==null || $rp6==null) {
	header("location:index.php?r=faculty/UpdateRP&msg=Please fill up all the required fields.&msgType=err&title=$title&journal=$journal&editors=$editors&volume=$volume&level=$level&authors=$authors");
} else { 
	...
	$result=mysqli_query($conn, $sql);
	header("location:index.php?r=faculty/refereedPublications&msg=Changes has been saved successfully.&msgType=succ");
}
mysqli_close($conn);
?>