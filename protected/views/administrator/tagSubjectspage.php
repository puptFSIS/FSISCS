...
<a data-category=design href="index.php?r=administrator/IPCR">IPCR</a>
<a data-category=design href="index.php?r=administrator/daily_time_record">DTR</a>
<a data-category=design href="index.php?r=administrator/SubjPrefer">Subject Preferences</a>
<a data-category=design href="index.php?r=administrator/TeachingAssignment">Teaching Assignment</a>
...
<?php
// function findCourse($courseAll, $course){
// 	$var = "";
...
<script type="text/javascript" src="<?php echo Yii::app()->getBaseUrl() ?>assets/js/dataTables.checkboxes.min.js"></script>
