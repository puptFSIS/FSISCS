...
<h2 class=underlined-header>Add Full Time Faculty</h2>
...
<form id="annc" name="annc" action="index.php?r=administrator/processAddFullTime" method="post">
<p style="margin-bottom: 9px;">*Name:
<select name="FTCode" id = "sy" style="width: 50%;">
