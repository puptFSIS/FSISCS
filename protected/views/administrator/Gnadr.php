...
include("config.php");
	...
	while($row = mysqli_fetch_array($result)) {
		echo '
		<form name=upnadr action="index.php?r=administrator/ProcessUpdateNADR&nadr='. $row['nadr'] .'" method="post">
		...
		<a href="index.php?r=administrator/crnadr&nadr=' . $row['nadr'] . '"><input type="button" style="width: 60px;" value="Remove"></p></a>
		</form>
		';
	}
		
		echo '
		<form name=newnadr action="index.php?r=administrator/NewNADR" method="post">
