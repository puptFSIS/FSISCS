...
?>
<form id=we action="index.php?r=faculty/ProcessUpdateVWork&orgname=<?php echo $_GET['orgname'];?>&orgadd=<?php echo $_GET['orgadd'];?>&fromm=<?php echo $_GET['fromm'];?>&fromd=<?php echo $_GET['fromd'];?>&fromy=<?php echo $_GET['fromy'];?>&tom=<?php echo $_GET['tom'];?>&tod=<?php echo $_GET['tod'];?>&toy=<?php echo $_GET['toy'];?>&hours=<?php echo $_GET['hours'];?>&pos=<?php echo $_GET['pos'];?>" method="post">
...
<p><center><input type=submit value='Save Changes'/> <a href="index.php?r=faculty/VoluntaryWork"><input type="button" value='Cancel'/></a></center></p>
</form>
</section>
<!-- End - Video -HTML5 -->
<br/>
