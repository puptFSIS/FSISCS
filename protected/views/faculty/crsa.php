...
<div class="box-success">
  <div class="box-content">
	<p>Do you really want to remove seminar(<?php echo $_GET['t'];?>) from your seminars attended?</p>
  </div>
</div>
<br /><center><a href="index.php?r=faculty/rsa&t=<?php echo $t;?>&n=<?php echo $n;?>&s=<?php echo $s;?>"><input type=button value=Yes></a>
<a href="index.php?r=faculty/sa"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
