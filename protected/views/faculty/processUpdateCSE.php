<?php
	...
	if($result) {
		header("Location: index.php?r=faculty/communitySE&msg=Community service eligibility has been updated");
	} else {
		header("Location: index.php?r=faculty/Error processing request.");
	}
?>