...
<?php 
	echo '	
	<form name="tcert" action="index.php?r=faculty/ProcessInsertTC" method="post">
...
<?php
	echo'
	<p><center><input type="submit" value="Save" /> <a href="index.php?r=faculty/TaxCertificate"><input type="button" value="Cancel" /></a></center></p>
	</form>';
?>
