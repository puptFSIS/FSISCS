...
<a href="index.php?r=administrator/HAPDtrTable&sort=pending"><input type="button" value="pending" /></a>
<a href="index.php?r=administrator/HAPDtrTable&sort=approved"><input type="button" value="approved" /></a>
<a href="index.php?r=administrator/HAPDtrTable&sort=disapproved"><input type="button" value="disapproved" /></a>
