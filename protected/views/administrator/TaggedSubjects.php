...
<a href="index.php?r=administrator/tagSubjects" class="btn btn-minisel">Add Prefered Subjects</a>
<br />
		...
		<tbody>
			<?php foreach ($SubPref as $row): ?>
				<tr>
					...
					<a href="index.php?r=administrator/DeleteTagged&schedID=<?php echo $row['schedID'] ?>&sem=<?php echo $sem ?>&sy=<?php $sy ?>" class="btn btn-primary" style="width:45px">DELETE</a>									
					</td>
