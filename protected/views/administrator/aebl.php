...
<form id=ebel action="index.php?r=administrator/processInsertEBL&level=<?php echo $_GET['level'];?>" method="POST">
<p style="margin-bottom: 9px;">NAME OF SCHOOL:<textarea name=el1 style="width: 320px; margin-top: -28px; margin-left: 35%;" placeholder='School Name' ></textarea></p>
<p style="margin-bottom: 9px;">DEGREE COURSE:<input name=el2 type=text style="width: 320px; margin-top: -28px; margin-left: 35%;"  placeholder='Degree Course'/></p>
...
<?php
	...
	echo '<option value="Not Yet">Not Yet</option>';
?>
</select></p>
<p style="margin-top: -37px; margin-left:53%;">UNITS EARNED:<input name=el4 type=text style="width: 100px; margin-top: -28px; margin-left: 40%;" placeholder='Total Units'/></p>
...
<input name=el7 type=text style="width: 230px; margin-top: -28px; margin-left: 50%;" placeholder='e.g. Valedictorian, Salutatorian, 1st ..'/></p>
