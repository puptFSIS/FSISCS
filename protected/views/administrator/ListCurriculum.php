...
echo '
				<table>
					<tbody>
						<tr>
							<td style="background-color: maroon; color: white; font-weight: bold; width: 75px;">CURRICULUM DESCRIPTION</td>
							<td style="background-color: maroon; color: white; font-weight: bold;"><button>EDIT</button></td>
						</tr>
			';
<section>
