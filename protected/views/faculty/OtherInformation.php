...
?>
<h2 class=underlined-header>Other Information</h2>
<?php
	if(isset($_GET['msg'])) {
	$msg = $_GET['msg'];
...
?>
<center><p><strong>SPECIAL SKILLS / HOBBIES</strong></p></center>
<hr style="margin-top: -12px;" />
<?php include("Gskh.php");?>

<hr style="margin-bottom: 8px;" />
<center><p><strong>NON-ACADEMIC DISTINCTIONS / RECOGNITION:</strong></p></center>
<hr style="margin-top: -12px;" />
<?php include("Gnadr.php");?>

<hr style="margin-bottom: 8px;" />
<center><p><strong>MEMBERSHIP IN ASSOCIATION / ORGANIZATION</strong></p></center>
<hr style="margin-top: -12px;" />
<?php include("Gmiao.php");?>
</section>
<!-- End - Video -HTML5 -->
<br/>
