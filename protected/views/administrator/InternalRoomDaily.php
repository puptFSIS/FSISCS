...
<h2 class="underlined-header">Internal Room Daily Schedule</h2>
<br />
	<form name="frmSched" method = "post" action = "index.php?r=administrator/InternalRoomDaily">
		...
		<select name = "sy" style="width: 30%;">
			<?php
				...
				else if(isset($_POST['sy']))
				{
					...
					$sql = "SELECT DISTINCT schoolYear FROM tbl_curriculum";
...
<section>	<?php if(isset($_POST['sem'])) { ?>
    <h2 class="underlined-header"> <a href="index.php?r=administrator/PrintRDSInternal&sem=<?php if(isset($_POST['sem']) and isset($_POST['sy'])) { echo $_POST['sem']; }?>&sy=<?php if(isset($_POST['sem']) and isset($_POST['sy'])) { echo $_POST['sy']; }?>" class="btn btn-s" target = "blank">Print</a></h2>
<?php } ?>
							...
							{	
								...
								if($csem==1) {
									...
									*/
									...
									$sql1 = "SELECT * FROM tbl_internaschedule WHERE sem = '$csem' and schoolYear = '$sy' and sroom = '$roomName' and stimeS < 1030";
									...
									$sql1 = "SELECT * FROM tbl_internaschedule WHERE sem = '$csem' and schoolYear = '$sy' and sroom2 = '$roomName' and stimeS2 < 1030";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									*/
									...
									$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sroom = '$roomName' and stimeS >= 1030 and stimeS < 1330) or (sem = '$csem' and schoolYear = '$sy' and sroom = '$roomName' and stimeS < 1030 and stimeE > 1030)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sroom2 = '$roomName' and stimeS2 >= 1030 and stimeS2 < 1330) or (sem = '$csem' and schoolYear = '$sy' and sroom2 = '$roomName' and stimeS2 < 1030 and stimeE2 > 1030)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									*/
									...
									$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sroom = '$roomName' and stimeS >=1330 and stimeS <1630) or (sem = '$csem' and schoolYear = '$sy' and sroom = '$roomName' and stimeS < 1330 and stimeE > 1330)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sroom2 = '$roomName' and stimeS2 >=1330 and stimeS2 <1630) or (sem = '$csem' and schoolYear = '$sy' and sroom2 = '$roomName' and stimeS2 < 1330 and stimeE2 > 1330)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									*/
									...
									$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sroom = '$roomName' and stimeS >= 1630) or (sem = '$csem' and schoolYear = '$sy' and sroom = '$roomName' and stimeS < 1630 and stimeE > 1630)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
									...
									$sql1 = "SELECT * FROM tbl_internaschedule WHERE (sem = '$csem' and schoolYear = '$sy' and sroom2 = '$roomName' and stimeS2 >= 1630) or (sem = '$csem' and schoolYear = '$sy' and sroom2 = '$roomName' and stimeS2 < 1630 and stimeE2 > 1630)";
									$query1 = mysqli_query($conn,$sql1);
									while($row1 = mysqli_fetch_array($query1))
									{
										$currID = $row1['currID'];
