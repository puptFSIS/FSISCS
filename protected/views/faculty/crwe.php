...
<br /><center><a href="index.php?r=faculty/rwe&com=<?php echo $_GET['com'];?>&pos=<?php echo $_GET['pos'];?>&fromm=<?php echo $fm;?>&fromd=<?php echo $fd;?>&fromy=<?php echo $fy;?>&tom=<?php echo $tm;?>&td=<?php echo $td;?>&toy=<?php echo $ty;?>"><input type=button value=Yes></a>
<a href="index.php?r=faculty/we"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
