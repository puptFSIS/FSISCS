...
include("taxinfo.php");
	echo '	
	<form name="tcert" action="index.php?r=administrator/ProcessUpdateTC" method="post">
	<p style="margin-bottom: 9px;">* COMMUNITY TAX CERTIFICATE NO.:<input name=tc1 type=text style="width: 62%; margin-top: -28px; margin-left: 35%;" value="' . $row['certno'] . '" /></p>
	<p style="margin-bottom: 9px;">* ISSUED AT: <input name=tc2 type=text style="width: 62%; margin-top: -28px; margin-left: 35%;" value="' . $row['issuedat'] . '" /></p>
	<p style="margin-bottom: 9px;">* ISSUED ON (mm/dd/yyyy): 
	';
?>
<select name=tc3 style="width:20%; margin-top:-28px; margin-left:210px;">
<?php
	$month = $row['ionm'];
	$day = $row['iond'];
	$year = $row['iony'];
...
<select name=tc4 style="width:10%; margin-top:-37px; margin-left:338px;">
<?php 
...
<select name=tc5 style="width:15%; margin-top:-37px; margin-left:405px;">
<?php 
...
<?php
	echo'
	<p><center><input type="submit" value="Save Changes" /> <a href="index.php?r=administrator/TaxCertificate"><input type="button" value="Cancel" /></a></center></p>
	</form>';
?>
