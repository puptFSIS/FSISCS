...
<?php 
  ...
  {
    echo '<ul class="widget-list categories-list">';
      echo "<li><a style='color:black' href='index.php?r=faculty/daily_time_record'>DTR Generator </button></a></li>";
      echo '<li><a style="color:black" href="index.php?r=faculty/DtrTable">Created DTRs</a></li>';
