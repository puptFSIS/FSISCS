...
<!-- Page title -->
<title>Faculty | Account Deactivated</title>
<!-- Page icon -->
...
<!-- Video - HTML5 -->
<section>
<h2 class=" underlined-header"><?php echo $_GET['header']; ?></h2>
<!-- End - Item description -->
	...
	<br />
	<center><a href="index.php?r=administrator/lfa"><input type="button" value="Back" /></a></center>
</section>
