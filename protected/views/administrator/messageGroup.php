...
<!-- Page title -->
<title>Other | Compose Email</title>
<!-- Page icon -->
...
<?php 
    ...
    foreach ($colleges as $row) {
        $string = $string."<".$row['CollegeName']."> ";
    }
?>


<h2 class="underlined-header">New Message</h2>
...
<form id="annc" name="annc" action="index.php?r=administrator/SendEmailByGroup" method="post" enctype="multipart/form-data">
...
<?php foreach ($receivers as $row): ?>
    <input type="hidden" name="college[]" value="<?php echo $row;?>">
<?php endforeach ?>
<center><p><input type="submit" value="Send" /> <a href="index.php?r=administrator/other"><input type="button" value="Cancel" /></a></p></center>
</form>
