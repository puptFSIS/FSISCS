...
<div class="box-success">
  <div class="box-content">
	<p>Do you really want to remove organization(<?php echo $_GET['o'];?>) from your professional organizations that you had joined?</p>
  </div>
</div>
<br /><center><a href="index.php?r=faculty/rpo&p=<?php echo $p;?>&o=<?php echo $o;?>&l=<?php echo $l;?>"><input type=button value=Yes></a>
<a href="index.php?r=faculty/proOrg"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
