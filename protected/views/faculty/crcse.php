...
<br /><center><a href="index.php?r=faculty/rcse&type=<?php echo $_GET['type'];?>&rating=<?php echo $_GET['rating'];?>&fm=<?php echo $_GET['fm'];?>&fd=<?php echo $_GET['fd'];?>&fy=<?php echo $_GET['fy'];?>&tm=<?php echo $_GET['tm'];?>&td=<?php echo $_GET['td'];?>&ty=<?php echo $_GET['ty'];?>"><input type=button value=Yes></a>
<a href="index.php?r=faculty/communitySE"><input type=button value=No></a></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
