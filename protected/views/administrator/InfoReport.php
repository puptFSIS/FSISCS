...
<!-- Page title -->
<title>Reports | Contact Info</title>
<!-- Page icon -->
...
<h2 class="underlined-header">Contact Info</h2>
<?php
	if(isset($_GET['msg'])) {
	$msg = $_GET['msg'];
...
?>
<a href="index.php?r=administrator/PrintInfoReport" class="btn btn-mini"><button>Print</button></a>
<section>
<br />

<table class=round-4 style="width:100%; ">
<thead>
<tr>
<th><h5>Branch Officials</h5></th>
<th><h5>Landline/Mobile</h5></th>
...
<?php
	...
	while($row = mysqli_fetch_array($query)) 
	{
		...
		echo '
			...
			<td style="text-align: left;"><a href="index.php?r=administrator/EditInfoReport&ID='.$ID.'" class="btn btn-mini"><button style="width:55px;">Edit</button></a><a href="index.php?r=administrator/crcl&ID='.$ID.'&roomName='.$Name.'&status=Branch Officials" class="btn btn-mini"><button style="width:55px;">Delete</button></a></td>
			</tr>
		';
		$i++;
	}
	...
	echo'
	<tr>
	<th><h5>New Faculty Faculty</h5></th>
	<th><h5></h5></th>
	<th><h5></h5></th>
	<th><h5></h5></th>
	</tr>
	...
	$sql = "SELECT * FROM tbl_masterlist WHERE Status = 'AS' AND schoolYear = '$schoolYear' order by FName ASC";
	$query = mysqli_query($conn,$sql);
	$i = 1;
	while($row = mysqli_fetch_array($query)) 
	{
	...
	$sql = "SELECT * FROM tbl_masterlist WHERE Status = 'SG' AND schoolYear = '$schoolYear' order by FName ASC";
	$query = mysqli_query($conn,$sql);
	$i = 1;
	while($row = mysqli_fetch_array($query)) 
	{
