...
<br /><center><a href="index.php?r=faculty/rref&name=<?php echo $_GET['name'];?>&address=<?php echo $_GET['address'];?>&telno=<?php echo $_GET['telno'];?>"><input type=button value=Yes></a>
<a href="index.php?r=faculty/References"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
