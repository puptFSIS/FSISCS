...
<br /><center><a href="index.php?r=faculty/reb&sname=<?php echo $_GET['sname'];?>&level=<?php echo $_GET['level'];?>"><input type=button value=Yes></a>
<a href="index.php?r=faculty/uebl&sname=<?php echo $_GET['sname'];?>&level=<?php echo $_GET['level'];?>"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
