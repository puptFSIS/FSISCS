...
<!-- Page title -->
<title>Announcement | Remove</title>
<!-- Page icon -->
...
<div class="box-success">
  <div class="box-content">
	<p>Do you really want to remove the news &amp; events "<strong><?php include("getNwEvtDetails.php"); echo $title; ?> </strong>"?</p>
  </div>
</div>
<br /><center><a href="index.php?r=administrator/rNwEvt&id=<?php echo $_GET['id'];?>"><input type=button value=Yes></a>
<a href="index.php?r=administrator/newsandevents"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
