...
<br />
	<form name="frmSched" method = "post" action = "index.php?r=administrator/TimePrefer">
								...
								while($row = mysqli_fetch_array($query))
								{
									...
									while($row1 = mysqli_fetch_array($query1))
									{
										...
										<tr><td style="text-align: center;">'. $day.'</td>
											...
											<a href="index.php?r=administrator/UpdateTimePrefer&time='.$time.'&sem='. $csem .'&sy='. $sy .'&timeID='. $timeID .'" class="btn btn-primary">UPDATE</a>
											<a href="index.php?r=administrator/DeletetimePrefer&timeID='. $timeID .'&sem='. $csem .'&sy='. $sy .'" class="btn btn-s">DELETE</a>
											</td>
										</tr>';
										} else {
										echo'
										<tr><td style="text-align: center;">'. $day.'</td>
											<td style="text-align: center;">'. $time.'</td>
											<td style="text-align: center;"> 
											<a href="index.php?r=administrator/UpdateTimePrefer&sem='. $csem .'&sy='. $sy .'&timeID='. $timeID .'" class="btn btn-primary">UPDATE</a>
											<a href="index.php?r=administrator/DeletetimePrefer&timeID='. $timeID .'&sem='. $csem .'&sy='. $sy .'" class="btn btn-s">DELETE</a>
											</td>
										</tr>';	
										}	
