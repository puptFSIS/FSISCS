...
<div class="box-success">
  <div class="box-content">
	<p>Do you really want to remove <?php echo $_GET['com'] . '(' . $_GET['pos'] . ')'?> from your work experience?</p>
  </div>
</div>
<br /><center><a href="index.php?r=administrator/rwe&com=<?php echo $_GET['com'];?>&pos=<?php echo $_GET['pos'];?>&fromm=<?php echo $fm;?>&fromd=<?php echo $fd;?>&fromy=<?php echo $fy;?>&tom=<?php echo $tm;?>&td=<?php echo $td;?>&toy=<?php echo $ty;?>"><input type=button value=Yes></a>
<a href="index.php?r=administrator/we"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
