...
<!-- Page title -->
<title>Bridging Subjects Scheduling | Schedule Management </title>
<!-- Page icon -->
...
?>-->
    <h2 class="underlined-header">Bridging Subjects Scheduling Management</h2>

    <a class="btn btn-primary" href="index.php?r=administrator/AddBridgeSubject">Add Bridge Subject</a>
    <a class="btn btn-primary" href="index.php?r=administrator/PrintBridgeSchedule">Print Schedule</a>
                    ...
                    <tr>
                        <td>
                            <?php
                                ...
                                $sqlCourse = "SELECT * FROM tbl_bridge_subject_course WHERE BridgeSubjectID = ".$row['BridgeSubjectID'];
                                $resultCourse = mysqli_query($conn, $sqlCourse);

                                while($rowCourse = mysqli_fetch_array($resultCourse))
                                {
                                    // Prints the cours name
                                    getSpecificCourseName($rowCourse['CourseID']);
                                    echo "<br>";
                                }
                            ?>
                        </td>
                        ...
                        <td>
                            <a class="btn btn-primary"
                               href="<?php echo "index.php?r=administrator/AddSecondDayBridgeSubject&BridgeSubjectID=".$row['BridgeSubjectID'];?>">ADD</a> <br>

                            <a class="btn btn-primary"
                               href="<?php echo "index.php?r=administrator/UpdateBridgeSubject&BridgeSubjectID=".$row['BridgeSubjectID'];?>">UPDATE</a> <br>

                            <a onclick="return confirm('Are you sure you want to do this?')"
                               href="<?php echo "index.php?r=administrator/processDeleteBridgeSubject&BridgeSubjectID=".$row['BridgeSubjectID']; ?>"
