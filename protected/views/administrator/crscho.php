...
<div class="box-success">
  <div class="box-content">
	<p>Do you really want to remove <?php echo $n;?> of <?php echo $s;?> from your scholarship list?</p>
  </div>
</div>
<br /><center><a href="index.php?r=administrator/rscho&name=<?php echo $n;?>&school=<?php echo $s;?>"><input type=button value=Yes></a>
<a href="index.php?r=administrator/scholarships"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
