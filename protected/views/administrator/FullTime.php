...
<h2 class="underlined-header">Full Time</h2>
<?php
	if(isset($_GET['msg'])) {
	$msg = $_GET['msg'];
...
<form name="frmSched" method = "post" action = "index.php?r=administrator/FullTime">
...
<?php
	if(isset($_POST['sy'])){
		$sy = $_POST['sy'];
		echo'
		<a href="index.php?r=administrator/AddFullTime&sy='.$sy.'" class="btn btn-mini"><button>Add</button></a>
		...
		<tbody>';
		$sql = "SELECT * FROM tbl_masterlist WHERE Status = 'FT' and schoolYear = '$sy' order by FName ASC";
