...
<div class="box-success">
  <div class="box-content">
	<p>Do you really want to remove <strong><?php echo $_GET['name'];?></strong> from <strong><?php echo $_GET['address'];?></strong> to your references?</p>
  </div>
</div>
<br /><center><a href="index.php?r=administrator/rref&name=<?php echo $_GET['name'];?>&address=<?php echo $_GET['address'];?>&telno=<?php echo $_GET['telno'];?>"><input type=button value=Yes></a>
<a href="index.php?r=administrator/References"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
