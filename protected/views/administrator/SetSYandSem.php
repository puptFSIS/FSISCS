...
<!-- Page title -->
<title>Administrator | Maintenance</title>
<!-- Page icon -->
...
<h2 class="underlined-header">Set Current School Year and Semester</h2>
<br />
    <form name="frmSched" method = "post" action = "index.php?r=administrator/SetSemSY">
        ...
        <br/>
        <br/>
        <input type="submit" name="btnSubmit" value="Set" />
        </form>
