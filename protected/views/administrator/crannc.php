...
<div class="box-success">
  <div class="box-content">
	<p>Do you really want to remove the announcement "<strong><?php include("getAnnDetails.php"); echo $title; ?> </strong>"?</p>
  </div>
</div>
<br /><center><a href="index.php?r=administrator/rannc&id=<?php echo $_GET['id'];?>"><input type=button value=Yes></a>
<a href="index.php?r=administrator/Announcements"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
