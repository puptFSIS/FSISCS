...
<div class="box-success">
  <div class="box-content">
	<p>Do you really want to remove <?php echo $_GET['sname'];?> from your educational background?</p>
  </div>
</div>
<br /><center><a href="index.php?r=administrator/reb&sname=<?php echo $_GET['sname'];?>&level=<?php echo $_GET['level'];?>"><input type=button value=Yes></a>
<a href="index.php?r=administrator/uebl&sname=<?php echo $_GET['sname'];?>&level=<?php echo $_GET['level'];?>"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
