...
<form id="questionFrm" name="questionFrm" action="index.php?r=administrator/processSaveAnswers" method=post>
...
<p><center><input type=submit value='Save Answers'/></center></p>
</form>
</section>
<!-- End - Video -HTML5 -->
<br/>
