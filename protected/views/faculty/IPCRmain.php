...
<!-- Page icon -->
<link href="puplogo.ico" rel="icon" type = "image/x-icon"/>
<!-- Stylesheets -->
...
<h2 class=widget-heading><center>IPCR</center></h2>
<div class=widget-content>
<ul class='widget-list categories-list'>
<form action="index.php?r=faculty/IPCRgenerate" method="post">
<div style="background-color: #c7c0ab; padding:15px; border-radius: 5px;">
    <center>Access IPCR by choosing specific month and year</center>
    <div style=" justify-content: center; align-items: center">
        <select class="selMos" name="Month" style="outline: 50px; width: 100%; height: 50px; margin-right: 20px;" required>
            <option value="" disabled selected>----Choose Month----</option>
            <option value="JJ">January - June</option>
            <option value="JD">July - December</option>
        </select>
        <br/>
        <select name="Year" id="ddlYears" style="outline: 50px; width: 100%; height: 50px;" required>
                <option value="" disabled selected>----Choose Year----</option>
        </select>
    </div>
    <br/>
    <center>
        <button type="submit" name="submit" style="width: 100px">Generate</button>
    </center>
</div>
</form>
    <script>
