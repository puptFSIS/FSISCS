...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>News &amp; Events</h2>
<ul class=tags-floated-list>
<li>
<a href="index.php?r=administrator/NwEvtNew" style="margin-top:-50px; margin-left:545px;">Create</a>
</li>
</ul>
<?php
	if(isset($_GET['msg'])) {
