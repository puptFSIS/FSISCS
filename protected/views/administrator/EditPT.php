...
<!-- Page title -->
<title>Faculty | Edit Full Time Faculty Status</title>
<!-- Page icon -->
...
<!-- Video - HTML5 -->
<section>
<h2 class=underlined-header>Edit Part Time Faculty Status</h2>
<br>
<?php
if (!isset($_GET['msg'])) {
...
<p style="margin-bottom: 9px; font-size:1.15em; display:inline;">Faculty Code: <strong style="margin-left: 18%; "><?php echo $PTCode ; ?></strong>	</p>
<input id=EmpID name="FCode" type="hidden" value="<?php echo $PTCode; ?>" required/>
<br>
<br>
<p style="font-size:1.15em;">Administrative Staff Name: <b style=" margin-left: 5%;"><?php echo $PTName; ?></b></p>
