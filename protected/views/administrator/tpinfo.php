...
<li>
<a href="index.php?r=administrator/crtp&tpID=<?php echo $_GET['tpID'];?>" style="margin-top:-50px; margin-left:538px;">Remove</a>
</li>
</ul>
<?php
	if(isset($_GET['msg'])) {
...
<form id="we" action="index.php?r=administrator/ProcessUpdateTP&tpID=<?php echo $tpID; ?>" method="post"  autocomplete="off" enctype="multipart/form-data">
...
<p style="margin-bottom: 9px;">
	<span>CHANGE CERTIFICATE:</span><br />
	<div id="take_picture">
...
<a href="index.php?r=administrator/TrainingPrograms"><input type="button" value='Cancel'/></a></center></p>
</form>
</section>
<!-- End - Video -HTML5 -->
<br/>
