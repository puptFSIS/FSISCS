<?php
	...
	if($row['fromm']=="January")
		...
		echo '
			...
			<td><a href="index.php?r=administrator/Uwe&pos=' . $row['positionTitle'] . '&fm=' . $row['fromm'] . '&fd=' . $row['fromd'] . '&fy=' . $row['fromy'] . '&tm=' . $row['tom'] . '&td=' . $row['tod'] . '&ty=' . $row['toy'] . '&com=' . $row['company'] . '">' . $row['positionTitle'] . '</a></td>
			<td>' . $row['company'] . '</td>
