...
<!-- Page title -->
<title>Make Up Class Management | Add</title>
<!-- Page icon -->
...
<form id="annc" name="annc" action="index.php?r=administrator/ProcessAddMakeupClass" method="post">
    <input name="RequestedFCode" type="hidden" value="<?php echo $_SESSION['FCode']; ?>"/>
