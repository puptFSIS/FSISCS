...
<form id=accsettingsuser action="index.php?r=faculty/processUpdateAccSettings&action=1" method=POST><p />
...
<hr />
<form id=accsettingspass action="index.php?r=faculty/processUpdateAccSettings&action=2" method=POST><p />
...
<hr />
<form id=accsettingsqa action="index.php?r=faculty/processUpdateAccSettings&action=3" method=POST><p />
