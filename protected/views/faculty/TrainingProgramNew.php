...
{
	document.getElementById('certificate_preview').src = "";
}
</script>
...
<h2 class=underlined-header>Add Training Program</h2>
...
<form id="we" action="index.php?r=faculty/ProcessInsertTP" method="post" autocomplete="off" enctype="multipart/form-data">

<p style="margin-bottom: 9px;">* TITLE / THEME / TOPIC:<input name=tp2 type=text style="width: 320px; margin-top: -28px; margin-left: 35%;"  value='<?php ?>'/></p>
...
<p style="margin-bottom: 9px;">* TYPE:
	...
	<select name=tp3 style="width:320px; margin-top:-28px; margin-left:210px;">
		...
		<option value="Seminar">Seminar/ Conference/ workshop/ convention etc.</option>
...
</p><p style="margin-bottom: 9px; margin-top: 0px;">* NO. OF HOURS:<input name=tp10 type=number style="width: 100px; margin-top: -28px; margin-left: 35%;"  value='<?php ?>'/></p>

<p style="margin-bottom: 9px;">* CONDUCTED/SPONSORED BY:<input name=tp11 type=text style="width: 320px; margin-top: -28px; margin-left: 35%;"  value='<?php ?>'/></p>
...
<p style="margin-bottom: 9px;">* VENUE:<input name=tp13 type=text style="width: 320px; margin-top: -28px; margin-left: 35%;"  value='<?php ?>'/></p>

<p style="margin-bottom: 9px;">
	<span>UPLOAD CERTIFICATE:</span>
	<img id="certificate_preview" alt="No Image Selected" width="250" height="180" /><br />
	<div id="take_picture">
		<label for="picture_seminar" class="btn">Take a Picture</label><br />
	</div>
...
<p><center><input type=submit value='Save'/><input type="reset" value='Reset' onclick="return ClearCertificatePreview();" /></center></p>
