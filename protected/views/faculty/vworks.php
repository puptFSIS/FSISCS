<?php
	...
	while($row = mysqli_fetch_array($result)) {
		...
		echo '
			...
			<tr>
			<td><a href="index.php?r=faculty/vwinfo&orgname=' . $row['orgname']. '&orgadd=' . $row['orgadd']. '&fromm=' . $row['fromm']. '&fromd=' . $row['fromd']. '&fromy=' . $row['fromy']. '&tom=' . $row['tom']. '&tod=' . $row['tod']. '&toy=' . $row['toy']. '&hours=' . $row['hours']. '&pos=' . $row['pos']. '">' . $row['orgname'] . '-' . $row['orgadd'] . '</a></td>
