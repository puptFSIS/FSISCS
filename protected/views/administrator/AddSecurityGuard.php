...
<!-- Page title -->
<title>Security Guard | Add</title>
<!-- Page icon -->
...
<h2 class=underlined-header>Add Security Guard</h2>
...
<form id="annc" name="annc" action="index.php?r=administrator/processAddSecurityGuard" method="post">
	<p style="margin-bottom: 9px;">*Name:
	<select name = "facode" style="width: 50%;">
		<?php 
			$sql = "SELECT FCode, LName, FName, MName FROM tbl_evaluationfaculty ORDER BY LName ASC";
