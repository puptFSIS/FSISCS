...
<?php 
	echo '	
	<form name="tcert" action="index.php?r=administrator/ProcessInsertTC" method="post">
	<p style="margin-bottom: 9px;">* COMMUNITY TAX CERTIFICATE NO.:<input name="certno" type=text style="width: 62%; margin-top: -28px; margin-left: 35%;" value="" /></p>
	<p style="margin-bottom: 9px;">* ISSUED AT: <input name="iat" type=text style="width: 62%; margin-top: -28px; margin-left: 35%;" value="" /></p>
	<p style="margin-bottom: 9px;">* ISSUED ON (mm/dd/yyyy): 
	';
?>
<select name="ionm" style="width:20%; margin-top:-28px; margin-left:210px;">
<?php
	$month = "January";
	$day = "1";
	$year = "1950";
...
<select name="iond" style="width:10%; margin-top:-37px; margin-left:338px;">
<?php 
...
<select name="iony" style="width:15%; margin-top:-37px; margin-left:405px;">
<?php 
...
<?php
	echo'
	<p><center><input type="submit" value="Save" /> <a href="index.php?r=administrator/TaxCertificate"><input type="button" value="Cancel" /></a></center></p>
	</form>';
?>
