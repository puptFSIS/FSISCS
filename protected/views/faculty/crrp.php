...
<br /><center><a href="index.php?r=faculty/rrp&Title=<?php echo $title;?>&Journal=<?php echo $journal;?>&Editors=<?php echo $editors;?>&Volume=<?php echo $volume;?>&Level=<?php echo $level;?>&Authors=<?php echo $authors;?>"><input type=button value=Yes></a>
<a href="index.php?r=faculty/refereedPublications"><input type=button value=No></center>
</section>
<!-- End - Video -HTML5 -->
<br/>
